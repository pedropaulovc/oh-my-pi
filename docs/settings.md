...
| `tools.artifactSpillThreshold` | number  | `50`    | KB of tool or async-progress output above which the model receives an artifact-backed preview.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
| `tools.artifactHeadBytes`      | number  | `20`    | KB of head kept inline in artifact-backed tool and async-progress previews; `0` = tail-only.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| `tools.artifactTailBytes`      | number  | `20`    | KB of tail kept inline in artifact-backed tool and async-progress previews.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| `tools.artifactTailLines`      | number  | `500`   | Max tail lines kept inline in artifact-backed tool and async-progress previews.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                |
