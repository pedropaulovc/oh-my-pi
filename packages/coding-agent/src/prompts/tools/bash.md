...
{{#if asyncEnabled}}- Finite commands of uncertain duration: `async: "auto"` keeps quick work inline and backgrounds slow work; `async: true` only when immediate background is needed.
