...
/**
 * Process home directory, cached but keyed on the `os.homedir` function
 * identity so a test that replaces `os.homedir` refreshes the cache instead of
 * leaking absolute paths through shortening.
 */
