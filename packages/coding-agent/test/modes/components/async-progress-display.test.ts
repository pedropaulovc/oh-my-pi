...
import { buildAsyncProgressDisplayMessage } from "@oh-my-pi/pi-tui/chat/transcript-render-helpers";
...
describe("async progress transcript display sanitization", () => {
	...
	it("shortens mixed-case Windows home paths without exposing the user directory", () => {
		...
		// Display paths normalize to POSIX separators after `~`, as `shortenPath` does.
